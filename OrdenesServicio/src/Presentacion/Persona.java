...
public class Persona extends javax.swing.JInternalFrame {
    ...
    String[] titulos = {"Identificación", "Nombres", "Apellidos", "Telefono", "Sexo", "Cargo","Dirección", "Estado"};//Titulos para Jtabla
    ...
    private void setFiltroTexto() {
        ...
        //TipoFiltro.setFiltraEntrada(sexo.getDocument(), FiltroCampos.NUM_LETRAS, 45, false);
        ...
        TipoFiltro.setFiltraEntrada(dpi.getDocument(), FiltroCampos.NUM_LETRAS, 45, true);
    ...
    private void MostrarDatos(String Dato) {
        ...
        String[] campos = {"dpi", "nombres", "apellidos", "telefono", "sexo", "cargo","direccion", "estado"};
        String[] condiciones = {"dpi"};
        String[] Id = {Dato};
        ...
        if (this.rbCodigo.isSelected()) {
            if (!Dato.isEmpty()) {
                ...
                Utilidades.setEditableTexto(this.JPanelCampos, false, null, true, "");
                Utilidades.esObligatorio(this.JPanelCampos, false);
                model = peticiones.getRegistroPorPks(model, "empleado", campos, condiciones, Id, "");
            } else {
                JOptionPane.showInternalMessageDialog(this, "Debe ingresar un dato para la busqueda");
            }
        }
        if (this.rbNombres.isSelected()) {
            ...
            Utilidades.setEditableTexto(this.JPanelCampos, false, null, true, "");
            Utilidades.esObligatorio(this.JPanelCampos, false);
            model = peticiones.getRegistroPorLike(model, "empleado", campos, "nombres", Dato, "");
        }
        if (this.rbApellidos.isSelected()) {
            removejtable();
            Utilidades.setEditableTexto(this.JPanelCampos, false, null, true, "");
            Utilidades.esObligatorio(this.JPanelCampos, false);
            model = peticiones.getRegistroPorLike(model, "empleado", campos, "apellidos", Dato, "");
        }
    ...
    private void filaseleccionada() {
        ...
        if (profesores.getValueAt(fila, 0) != null) {
            ...
            String[] campos = {"dpi", "nombres", "apellidos", "telefono", "sexo", "cargo","direccion", "estado"};
            Component[] cmps = {dpi, nombres, apellidos, telefono, sexo1,cargo, direccion, estado};
            Utilidades.setEditableTexto(this.JPanelCampos, true, null, true, "");
            peticiones.getRegistroSeleccionado(cmps, "empleado", campos, cond, id, "", null);
...
//
//            rs = ac.getUltimoRegistro("personas", "idpersonas");
//            if (rs != null) {
//                try {
...
//    }
    ...
    private void initComponents() {
        ...
        jLabel1.setBounds(90, 30, 80, 20);

        jLabel2.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel2.setHorizontalAlignment(javax.swing.SwingConstants.TRAILING);
        jLabel2.setText("Apellidos");
        JPanelCampos.add(jLabel2);
        jLabel2.setBounds(90, 60, 80, 20);
        ...
        nombres.setBounds(180, 30, 250, 21);
        ...
        jLabel18.setBounds(520, 120, 80, 20);

        sexo1.setFont(new java.awt.Font("Arial", 1, 12)); // NOI18N
        sexo1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { " ", "F", "M" }));
        sexo1.setName("sexo"); // NOI18N
        sexo1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                sexo1ActionPerformed(evt);
            }
        });
        JPanelCampos.add(sexo1);
        sexo1.setBounds(610, 120, 160, 21);

        jLabel19.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel19.setHorizontalAlignment(javax.swing.SwingConstants.TRAILING);
        jLabel19.setText("Cargo:");
        JPanelCampos.add(jLabel19);
        jLabel19.setBounds(120, 120, 50, 17);

        cargo.setFont(new java.awt.Font("Arial", 1, 12)); // NOI18N
        cargo.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Supervisor", "Mecanico A", "Mecanico B", "Ayudante de Mecanico", "Electromecanico", "Secretaria", "Seguridad", "Digitador", "Contador", "Gerente", " " }));
        cargo.setName("sexo"); // NOI18N
        cargo.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                cargoActionPerformed(evt);
            }
        });
        JPanelCampos.add(cargo);
        cargo.setBounds(180, 120, 250, 21);
    ...
    private void bntGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bntGuardarActionPerformed
        ...
        if (AccesoUsuario.AccesosUsuario(bntGuardar.getName()) == true) {
            ...
            if (resp == 0) {
                ...
                Object[] valores = {dpi.getText(), nombres.getText(), apellidos.getText(), telefono.getText(), sexo1.getSelectedItem(),cargo.getSelectedItem(),
                    direccion.getText(), estad
    ...
    private void bntEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bntEliminarActionPerformed
        ...
        if (AccesoUsuario.AccesosUsuario(bntEliminar.getName()) == true) {
            ...
            if (resp == 0) {
                ...
                int fila = profesores.getSelectedRow();
                String id = (String) "" + profesores.getValueAt(fila, 0);
                String nombreTabla = "empleado", nomColumnaCambiar = "estado";
                String nomColumnaId = "dpi";
                int seguardo = 0;
    ...
    private void bntModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bntModificarActionPerformed
        ...
        if (AccesoUsuario.AccesosUsuario(bntModificar.getName()) == true) {
            ...
            if (resp == 0) {
                //generacodigoprofe();
                String nomTabla = "empleado";
                String columnaId = "dpi";
                int seguardo = 0;
                int fila = profesores.getSelectedRow();
                String id = (String) "" + profesores.getValueAt(fila, 0);
                String campos = "dpi, nombres, apellidos, telefono, sexo, cargo, direccion, estado";
