...
public class Servicio extends javax.swing.JInternalFrame {
    ...
    private void MostrarDatos(String Dato) {
        String[] campos = {"servicio.idservicio", "servicio.descripcion", "servicio.estado"};

        String[] condiciones = {"servicio.idservicio"};
        String[] Id = {Dato};
        ...
        if (this.rbCodigo.isSelected()) {
            if (!Dato.isEmpty()) {
                ...
                Utilidades.setEditableTexto(this.JPanelCampos, false, null, true, "");
                Utilidades.esObligatorio(this.JPanelCampos, false);
                model = peticiones.getRegistroPorPks(model, "servicio", campos, condiciones, Id, "");
            } else {
        ...
        if (this.rbNombres.isSelected()) {
            ...
            Utilidades.setEditableTexto(this.JPanelCampos, false, null, true, "");
            Utilidades.esObligatorio(this.JPanelCampos, false);
            model = peticiones.getRegistroPorLike(model, "servicio", campos, "servicio.descripcion", Dato, "");
        }
    ...
    private void filaseleccionada() {
        ...
        String[] cond = {"servicio.idservicio"};
        String[] id = {"" + curso.getValueAt(fila, 0)};

        if (curso.getValueAt(fila, 0) != null) {

            String[] campos = {"servicio.descripcion", "servicio.estado"};
            Component[] cmps = {descripcion, estado};
            Utilidades.setEditableTexto(this.JPanelCampos, true, null, true, "");

            peticiones.getRegistroSeleccionado(cmps, "servicio", campos, cond, id, "", null);
    ...
    private void initComponents() {
        ...
        curso.setModel(model = new DefaultTableModel(null, titulos)
            ...
            jLabel8.setText("<--Marca de Vehiculos-->");
    ...
    private void bntEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bntEliminarActionPerformed
        ...
        if (AccesoUsuario.AccesosUsuario(bntEliminar.getName()) == true) {
            ...
            if (resp == 0) {
                ...
                String nombreTabla = "servicio", nomColumnaCambiar = "estado";
                String nomColumnaId = "idservicio";
                int seguardo = 0;
    ...
    private void bntModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bntModificarActionPerformed
        ...
        if (AccesoUsuario.AccesosUsuario(bntModificar.getName()) == true) {
            ...
            if (resp == 0) {
                ...
                String nomTabla = "servicio";
                String columnaId = "idservicio";
                int seguardo = 0;
                int fila = curso.getSelectedRow();
                String id = (String) "" + curso.getValueAt(fila, 0);
                String campos = "descripcion, estado";
