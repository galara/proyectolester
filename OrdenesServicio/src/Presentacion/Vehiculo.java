...
public class Vehiculo extends javax.swing.JInternalFrame {
    ...
    String[] titulos = {"Matricula", "Modelo", "Marca", "Targeta","Estado"};//Titulos para Jtabla
    ...
    public void llenarcombocarrera() {
        String Dato = "1";
        String[] campos = {"descripcion", "idmarca"};
        String[] condiciones = {"estado"};
        String[] Id = {Dato};
        marca.removeAllItems();
        Component cmps = marca;
        getRegistroCombocarrera("marca", campos, condiciones, Id);
    ...
    public void getRegistroCombocarrera(String tabla, String[] campos, String[] campocondicion, String[] condicionid) {
        try {
            ...
            if (rs != null) {
                ...
                marca.setModel(modeloComboBox);

                modeloComboBox.addElement(new Marca("", "0"));
                if (rs.next()) {//verifica si esta vacio, pero desplaza el puntero al siguiente elemento
                    ...
                    while (rs.next()) {//mientras tenga registros que haga lo siguiente
                        count++;
                        modeloComboBox.addElement(new Marca(rs.getString(1), "" + rs.getInt(2)));
    ...
    private void MostrarDatos(String Dato) {
        String[] campos = {"vehiculos.matricula","vehiculos.modelo", "marca.descripcion", "vehiculos.tarjeta_circulacion", "vehiculos.estado"};
        //String[] condiciones = {"vehiculos.matricula"};
        //String[] Id = {Dato};
        String inner = " INNER JOIN marca on vehiculos.idmarca=marca.idmarca";
...
//        }
        if (this.rbNombres.isSelected()) {
            ...
            Utilidades.setEditableTexto(this.JPanelCampos, false, null, true, "");
            Utilidades.esObligatorio(this.JPanelCampos, false);
            model = peticiones.getRegistroPorLike(model, "vehiculos", campos, "vehiculos.matricula", Dato, inner);
        }
...
//    }
    ...
    private void filaseleccionada() {
        ...
        String[] cond = {"vehiculos.matricula"};
        ...
        if (pensum.getValueAt(fila, 0) != null) {
            ...
            rs = ac.getRegistros("vehiculos", campos, cond, id, inner);
    ...
    private void initComponents() {
        ...
        tarjeta = new elaprendiz.gui.textField.TextField();
        ...
        estado.setBounds(110, 90, 160, 21);

        marca.setModel(modelCombo = new DefaultComboBoxModel());
        marca.setComponentPopupMenu(popupcarrera);
        marca.setEnabled(false);
        marca.setName("Pensum"); // NOI18N
        JPanelCampos.add(marca);
        marca.setBounds(110, 60, 160, 21);

        jLabel5.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel5.setHorizontalAlignment(javax.swing.SwingConstants.TRAILING);
        jLabel5.setText("Marca :");
        JPanelCampos.add(jLabel5);
        jLabel5.setBounds(20, 60, 80, 20);

        matricula.setEditable(false);
        matricula.setHorizontalAlignment(javax.swing.JTextField.LEFT);
        matricula.setName("matricula"); // NOI18N
        JPanelCampos.add(matricula);
        matricula.setBounds(110, 30, 160, 21);

        jLabel2.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel2.setHorizontalAlignment(javax.swing.SwingConstants.TRAILING);
        jLabel2.setText("Modelo :");
        JPanelCampos.add(jLabel2);
        jLabel2.setBounds(310, 30, 90, 20);

        modelo.setEditable(false);
        modelo.setHorizontalAlignment(javax.swing.JTextField.LEFT);
        modelo.setName("descripcion"); // NOI18N
        JPanelCampos.add(modelo);
        modelo.setBounds(410, 30, 130, 21);

        jLabel3.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel3.setHorizontalAlignment(javax.swing.SwingConstants.TRAILING);
        jLabel3.setText("No targeta :");
        JPanelCampos.add(jLabel3);
        jLabel3.setBounds(310, 60, 90, 17);

        tarjeta.setEditable(false);
        tarjeta.setHorizontalAlignment(javax.swing.JTextField.LEFT);
        tarjeta.setName("matricula"); // NOI18N
        JPanelCampos.add(tarjeta);
        tarjeta.setBounds(410, 60, 130, 21);
    ...
    private void bntGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bntGuardarActionPerformed
        ...
        if (AccesoUsuario.AccesosUsuario(bntGuardar.getName()) == true) {
            ...
            if (resp == 0) {
                ...
                String campos = "matricula, modelo, idmarca, tarjeta_circulacion,estado";
                Marca carr = (Marca) marca.getSelectedItem();
                ...
                Object[] valores = {matricula.getText(),modelo.getText(), idcarrera, tarjeta.getText(), estad 
                };
    ...
    private void bntEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bntEliminarActionPerformed
        ...
        if (AccesoUsuario.AccesosUsuario(bntEliminar.getName()) == true) {
            ...
            if (resp == 0) {
                ...
                String nombreTabla = "vehiculos", nomColumnaCambiar = "estado";
                String nomColumnaId = "matricula";
                int seguardo = 0;
    ...
    private void bntModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bntModificarActionPerformed
        ...
        if (AccesoUsuario.AccesosUsuario(bntModificar.getName()) == true) {
            ...
            if (resp == 0) {
                ...
                String nomTabla = "vehiculos";
                String columnaId = "matricula";
                int seguardo = 0;
                int fila = pensum.getSelectedRow();
                String id = (String) "" + pensum.getValueAt(fila, 0);
                String campos = "matricula, modelo, idmarca, tarjeta_circulacion, estado";
                ...
                Object[] valores = {matricula.getText(),modelo.getText(), idcarrera, tarjeta.getText(), estad, id
                };
...
//        }
    ...
    private elaprendiz.gui.textField.TextField matricula;
    private elaprendiz.gui.textField.TextField modelo;
    ...
    private elaprendiz.gui.textField.TextField tarjeta;
