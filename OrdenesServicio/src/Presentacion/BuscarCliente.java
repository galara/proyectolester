...
import static Presentacion.Ordenservicio.idclientes;
...
public class BuscarCliente extends javax.swing.JInternalFrame {
    ...
    String[] titulos = {"Nit", "Nombres", "Apellidos", "Telefono", "Direccipon", "Id"};//Titulos para Jtabla
...
//        Utilidades.setEditableTexto(this.JPanelCampos, false, null, true, "");
    ...
    private void MostrarDatos(String Dato) {
        String[] campos = {"cliente.nit", "cliente.nombres", "cliente.apellidos", "cliente.telefono", "cliente.direccion", "cliente.idcliente"};
        String[] condiciones = {"cliente.estado=1 and cliente.nit"};
        String[] Id = {Dato};
        ...
        if (this.rbNombre.isSelected()) {
            removejtable();
            model = peticiones.getRegistroPorLike(model, "cliente", campos, "cliente.estado=1 and cliente.nombres", Dato, "");
        }
...
//    }
    ...
    private void clientesKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_clientesKeyPressed
        ...
        if (key == java.awt.event.KeyEvent.VK_ENTER) {
            ...
            nitcliente.setText(clientes.getValueAt(p, 0).toString());
            ...
            nombre.setText(clientes.getValueAt(p, 1).toString() + " " + clientes.getValueAt(p, 2).toString());
            ...
            telefono.setText(clientes.getValueAt(p, 3).toString());
            direccion.setText(clientes.getValueAt(p, 4).toString());
...
//            }
            idclientes=(clientes.getValueAt(p, 5).toString());
            this.dispose();
        }
